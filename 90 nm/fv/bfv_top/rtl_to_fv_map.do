...
# Generated on: Wed Mar 25 16:34:46 IST 2026 (Wed Mar 25 11:04:46 UTC 2026)
...
set_log_file fv/bfv_top/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/bfv_top -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  bfv_mod_adder.v bfv_mod_mult.v bfv_keygen.v bfv_encrypt_core.v bfv_top.v
elaborate_design -golden -root {bfv_top} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/bfv_top/fv_map.v.gz
elaborate_design -revised -root {bfv_top}
...
#add_name_alias fv/bfv_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/bfv_top/rtl_to_fv_map.log
}
